...
# Пользователь также может ввести имя или фамилию, и Вы должны реализовать функционал для изменения и удаления данны
...
def add_new_contact():
    ...
    if not exist_contact(0, " ".join(answers)):
        ...
        print("The entry has been successfuly added to the phonebook!\n")
    else:
